Ext.define('App.page.PageIndexManager', {
    extend: 'Ext.grid.Panel',

    alias: 'widget.pageindexmanager',
    requires: [
        ...
        Dialog.batch({
            ...
            callback: function (btn) {
                if (btn == 'yes') {
                    ...
                    self.apis.Page.setIndexEnable
                        .wait(self, '正在设置页面...')
                        .call({id: ids[0]}, function () {
                            self.refreshStore();
                        })
                }
            }
    ...
    onAfterApply: function () {
        var store = this.apis.Page.getIndexPages.createPageStore();
        this.setStore(store);
        store.load();
    },
