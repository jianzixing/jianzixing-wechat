Ext.define('App.integral.IntegralRecordManager', {
    ...
    onAfterApply: function () {
        var store = this.apis.Integral.getRecords.createPageStore();
        this.setStore(store);
        store.load();
    },
    ...
    onSearchFormButtonClick: function (form) {
        ...
        var store = this.apis.Integral.getRecords.createPageStore({search: data});
        this.setStore(store);
        store.load();
    }
