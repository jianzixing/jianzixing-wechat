 ...
 * @private
 */
Ext.define('UXApp.colorpick.SliderSaturation', {
    extend : 'UXApp.colorpick.Slider',
    ...
    setHue: function(hue) {
        ...
        rgb = UXApp.colorpick.ColorUtils.hsv2rgb(hue, 1, 1);
        hex = UXApp.colorpick.ColorUtils.rgb2hex(rgb.r, rgb.g, rgb.b);
