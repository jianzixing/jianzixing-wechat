 ...
 * @private
 */
Ext.define('UXApp.colorpick.Selection', {
    ...
    applyColor: function (color) {
        var c = color;
        if (Ext.isString(c)) {
            c = UXApp.colorpick.ColorUtils.parseColor(color, this.getAlphaDecimalFormat());
        }
        return c;
    },

    applyFormat: function (format) {
        var formats = UXApp.colorpick.ColorUtils.formats;
    ...
    applyValue: function (color) {
        ...
        var c = UXApp.colorpick.ColorUtils.parseColor(color || '#000000', this.getAlphaDecimalFormat());
        return this.formatColor(c);
    },

    formatColor: function (color) {
        return UXApp.colorpick.ColorUtils.formats[this.getFormat()](color);
    },
