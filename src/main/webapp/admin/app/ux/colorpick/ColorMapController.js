 ...
 * @private
 */
Ext.define('UXApp.colorpick.ColorMapController', {
    ...
    onColorBindingChanged: function (selectedColor) {
        ...
        hsv = UXApp.colorpick.ColorUtils.rgb2hsv(rgba.r, rgba.g, rgba.b);
    ...
    onHueBindingChanged: function (hue) {
        ...
        fullColorRGB = UXApp.colorpick.ColorUtils.hsv2rgb(hue, 1, 1);
        hex = UXApp.colorpick.ColorUtils.rgb2hex(fullColorRGB.r, fullColorRGB.g, fullColorRGB.b);
