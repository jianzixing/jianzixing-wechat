Ext.define('UXApp.colorpick.Selector', {
    ...
    requires: [
        ...
        'UXApp.colorpick.ColorMap',
        'UXApp.colorpick.SelectorModel',
        'UXApp.colorpick.SelectorController',
        'UXApp.colorpick.ColorPreview',
        'UXApp.colorpick.Slider',
        'UXApp.colorpick.SliderAlpha',
        'UXApp.colorpick.SliderSaturation',
        'UXApp.colorpick.SliderValue',
        'UXApp.colorpick.SliderHue'
    ],
     ...
     * these are relied upon by the {@link UXApp.colorpick.Button} and the {@link UXApp.colorpick.Field}.
     */
     ...
     * @param {UXApp.colorpick.Selector} this
