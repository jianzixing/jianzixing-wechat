 ...
 */
Ext.define('UXApp.colorpick.SelectorModel', {
    ...
    formulas: {
        ...
        hex: {
            get: function (get) {
                ...
                result = UXApp.colorpick.ColorUtils.rgb2hex(r, g, b);
                return '#' + result;
            },

            set: function (hex) {
                var rgb = UXApp.colorpick.ColorUtils.parseColor(hex);
                this.changeRGB(rgb);
            }
        },
    ...
    changeHSV: function (hsv) {
        ...
        var rgb = UXApp.colorpick.ColorUtils.hsv2rgb(hsv.h, hsv.s, hsv.v);
    ...
    changeRGB: function (rgb) {
        ...
        var hsv = UXApp.colorpick.ColorUtils.rgb2hsv(rgb.r, rgb.g, rgb.b);
