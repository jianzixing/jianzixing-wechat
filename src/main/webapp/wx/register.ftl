...
<div class="wx_wrap" id="wrapBody" data-redirect="${r}">
    <div class="m_header" style="">
        <div class="m_header_bar">
            ...
            <div class="m_header_bar_title">用户注册</div>
        </div>
    ...
    <div class="page">
        ...
        <a href="javascript:;" id="loginBtn" class="btn">注 册</a>
        <div class="quick-nav clearfix">
            <!--content-id="username_login"-->
            <a content-id="sms_login" href="${JZXUrl(Request,'/wx/login.jhtml')}" class="planBLogin"
               style="float: unset">
                <span class="txt-planBLogin">已有账号点击<span style="color: #409eff">登录</span></span>
            </a>
        </div>
        <div class="login-type">
            <div class="agreement-tips">
                <p>注册即代表您已同意<a href="">网站使用协议</a></p>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript" src="${JZXUrl(Request)}/wx/js/common.js"></script>
<script type="text/javascript" src="${JZXUrl(Request)}/wx/js/register.js"></script>
</body>
</html>
