...
<div class="wx_wrap" id="wrapBody"
     ...
     load-url="${JZXUrl(Request)}/wx/mine/goods_mark_list.jhtml"
     cancel-url="${JZXUrl(Request)}/wx/mine/goods_mark_cancel.jhtml"
     goods-url="${JZXUrl(Request)}/wx/goods_detail.jhtml?id=">
    <div class="m_header" style="">
        <div class="m_header_bar">
            <div class="m_header_bar_back"></div>
            <div class="m_header_bar_title">商品收藏</div>
        </div>
    ...
    <div class="fav_fixbar" style="position: fixed;display: none">
        ...
        <a href="javascript:void(0);" class="btn" id="multiCancle">取消关注</a>
    </div>
</div>
...
<div class="mod_alert_v2 fixed">
    ...
    <p>确认要取消关注么？</p>
    <p class="btns">
        <a href="javascript:;" id="ui_btn_confirm" class="btn btn_1">取消收藏</a>
